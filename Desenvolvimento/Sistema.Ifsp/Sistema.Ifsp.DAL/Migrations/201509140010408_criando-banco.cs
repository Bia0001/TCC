    ...
    public partial class criandobanco : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        idAdministradorSistema = c.Int(nullable: false, identity: true),
                        prontuario_idProntuario = c.Int(),
                    })
                .PrimaryKey(t => t.idAdministradorSistema)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AdministradorSitema", "prontuario_idProntuario", "dbo.Prontuario");
            ...
            DropIndex("dbo.AdministradorSitema", new[] { "prontuario_idProntuario" });
